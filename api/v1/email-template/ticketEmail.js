...
const ticketSolvedEmailTemplate = async (data) => {
  return `
  ...
  <table align="center" cellpadding="0" cellspacing="0" border="0" width="600" style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 15px; box-shadow: 0 8px 20px rgba(0, 0, 0, 0.1); overflow: hidden;">
    ...
    <tr>
      <td style="background-color: #003366; padding: 40px; text-align: center; color: white; border-top-left-radius: 15px; border-top-right-radius: 15px;">
        ...
        <p style="font-size: 16px; margin-top: 10px;">Your issue has been successfully resolved</p>
      </td>
    </tr>
    ...
    <tr>
      <td style="padding: 40px; color: #444444; font-size: 16px;">
        ...
        <p style="margin-bottom: 20px; font-size: 16px;">We are pleased to inform you that your ticket has been resolved. Here are the details:</p>

        <!-- Ticket Details -->
        <div style="background-color: #f4f8fc; border-radius: 10px; border: 1px solid #dde6f2; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.05); padding: 20px; font-size: 16px;">
          <table style="width: 100%; font-size: 16px; border-spacing: 0; line-height: 1.8;">
            <tr>
              <td style="font-weight: bold; padding: 8px 0; width: 40%; color: #003366;">Ticket ID:</td>
              <td style="padding: 8px 0;">${data.ticket_id}</td>
            ...
            <tr>
              <td style="font-weight: bold; padding: 8px 0; color: #003366;">Resolved By:</td>
              <td style="padding: 8px 0;">${data.resolved_by}</td>
            </tr>
            <tr>
              <td style="font-weight: bold; padding: 8px 0; color: #003366;">Solving Date</td>
              <td style="padding: 8px 0;">${data.solving_date}</td>
            </tr>
          </table>
        </div>

        <p style="margin-top: 30px; font-size: 16px; line-height: 1.8;">
          If you have any further issues or require additional assistance, please do not hesitate to reach out by logging into the <a href="https://helpdesk.dbl-group.com/" style="color: #003366; text-decoration: underline;">IT Ticketing System</a>.
        </p>
